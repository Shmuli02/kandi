...
\documentclass[finnish,oneside,censored,tkt]{HYthesisML} 
...
\title{Turvallisten kirjautumismenetelmien vertailu}

\author{Samuli Kaleva}
\date{\today}
...
\supervisors{FT. Lea Kutvonen, Miikka Tiainen}

\keywords{Kirjautumismenetelmät, todentaminen}
...
\include{Ch.20_Kirjautumismenetelmät}
\include{Ch.45_Turvallisuus}
\include{Ch.40_Vertailu}
\include{Ch.50_Tulevaisuus}
\include{Ch.70_Yhteenveto}
